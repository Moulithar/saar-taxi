              ...
              <SheetContent side="right" className="bg-background border-l border-border">
                <div className="flex flex-col h-full">
                  <div className="flex-1 space-y-6 py-6">
                    <Link to="/" className="block text-foreground hover:text-primary transition-colors text-lg">
                      Home
                    </Link>
                    <Link to="/book" className="block text-foreground hover:text-primary transition-colors text-lg">
                      Book a Ride
                    </Link>
                    <Link to="/about" className="block text-foreground hover:text-primary transition-colors text-lg">
                      About Us
                    </Link>
                  </div>
